class AutoPlayer:
    ...
    def __repr__(self) -> str:
        return f'AutoPlayer(board: {self.board}, ' \
               f'Autoplayer: {self.opponent})'
    ...
    def evaluate(self) -> int:
        ...
        for col in range(3):
            ...
            if b[0][col] == b[1][col] and b[1][col] == b[2][col]:
                if b[0][col] == self.opponent:
                    return -10

        # Check for Diagonals for X or O victory.
        if b[0][0] == b[1][1] and b[1][1] == b[2][2]:
            if b[0][0] == self.opponent:
                return -10

        if b[0][2] == b[1][1] and b[1][1] == b[2][0]:

            if b[0][2] == self.opponent:
                return -10
